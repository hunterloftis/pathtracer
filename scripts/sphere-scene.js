class SphereScene extends Scene {
  constructor () {
    ...
    this.objects = [
      new Sphere(new Vector3(-5, 1, -4.1), 1, materials.gold),
      new Sphere(new Vector3(-3.1, 4, -10), 4, materials.redPlastic),
      new Sphere(new Vector3(-1.1, 1, -4.2), 1, materials.bluePlastic),
      new Sphere(new Vector3(1, 1, -5), 1, materials.silver),
      new Sphere(new Vector3(3, 1, -4.2), 1, materials.greenGlass),
